...
#include <pcl/Contextualizers/extract_indices.h>
#include <pcl/Contextualizers/voxel_grid.h>
#include <pcl/Contextualizers/passthrough.h>
...
class Contextualizer : public DrawingAnnotator
{
private:
...
public:
  ...
  Contextualizer(): DrawingAnnotator(__func__)
  {
    color=0;
  }
  ...
  {
    outInfo("initializing Contextualizer");
  ...
  TyErrorId destroy()
  {
    outInfo("destroying Contextualizer");
    return UIMA_ERR_NONE;
  }
  ...
  {
    MEASURE_TIME;
    outInfo("running Contextualizer");
    return UIMA_ERR_NONE;
  }
