...
class InverseLearner : public DrawingAnnotator
{
private:
...
public:
  ...
  InverseLearner(): DrawingAnnotator(__func__)
  {
    color=0;
  }
  ...
  {
    outInfo("initializing InverseLearner");
  ...
  TyErrorId destroy()
  {
    outInfo("destroying InverseLearner");
    return UIMA_ERR_NONE;
  }
  ...
  {
    MEASURE_TIME;
    outInfo("running InverseLearner");
    return UIMA_ERR_NONE;
  }
