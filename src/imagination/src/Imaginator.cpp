...
#include <pcl/Imaginators/extract_indices.h>
#include <pcl/Imaginators/voxel_grid.h>
#include <pcl/Imaginators/passthrough.h>
...
class Imaginator : public DrawingAnnotator
{
private:
...
public:
  ...
  Imaginator(): DrawingAnnotator(__func__)
  {
    color=0;
  }
  ...
  {
    outInfo("initializing Imaginator");
